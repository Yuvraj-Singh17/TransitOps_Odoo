...
function CostSummaryCard({ summary }) {
  ...
  return (
    <div className="bg-bg-card rounded-xl border shadow-sm p-5">
      <div className="flex items-center justify-between mb-4">
        <h4 className="font-semibold text-text-primary">{vehicleRegNumber}</h4>
      ...
      <div className="space-y-3">
        ...
        <div className="border-t pt-3 flex items-center justify-between">
          <span className="text-sm font-semibold text-text-primary">Total Operational Cost</span>
