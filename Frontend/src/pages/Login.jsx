      ...
      <div className="flex w-full max-w-5xl bg-[#121821] rounded-3xl shadow-2xl overflow-hidden border border-[#1F2937]">
        ...
        <div className="hidden lg:block lg:w-1/2 relative bg-[#0F172A]">
          ...
          <div className="absolute bottom-12 left-10 pr-8">
            ...
            <p className="text-[#9CA3AF]">Sign in to access the intelligent operating system for modern transport fleets.</p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center animate-fade-in bg-[#121821]">
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-[#E5E7EB] mb-1.5 ml-1">Email or Phone Number</label>
                <input
                  type="text"
                  {...register("identifier")}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#7C3AED] text-white hover:bg-[#6D28D9] transition-all duration-300 py-3.5 rounded-xl font-medium focus:outline-none focus:ring-4 focus:ring-[#7C3AED]/30 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed mt-2 shadow-lg shadow-[#7C3AED]/25"
              >
